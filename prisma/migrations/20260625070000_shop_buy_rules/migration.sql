CREATE TABLE IF NOT EXISTS shop_buy_rules (
  ...
  scope_trend_threshold_pct DECIMAL(5,2),
...
CREATE INDEX IF NOT EXISTS shop_buy_rules_shop_priority ON shop_buy_rules(shop_id, priority);
